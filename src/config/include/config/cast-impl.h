...
namespace execHelper {
    namespace config {
        namespace detail {
            /**
             * \brief Partial specialization for casting the given type U to an optional of type bool
             */
            template<typename U>
            class Cast<bool, U> {
                public:
            ...
            /**
             * \brief Partial specialization for casting the given type U to an optional of type vector<T>
             */
            template<typename T, typename U>
            class Cast<std::vector<T>, U> {
                public:
                    /*! \copydoc Cast<T,U>::cast(const U& values)
                     */
            ...
            /**
             * \brief Partial specialization for casting the given type U to an optional of type Path
             */
            template<typename U>
            class Cast<Path, U> {
                public:
            ...
            inline boost::optional<bool> Cast<bool, U>::cast(const U& values) noexcept {
                ...
                return (values.back() == "yes" || values.back() == "1" || values.back() == "true");
            }

            template<typename T, typename U>
            inline boost::optional<std::vector<T>> Cast<std::vector<T>, U>::cast(const U& values) noexcept {
                std::vector<T> result;
