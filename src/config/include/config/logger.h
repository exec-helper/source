...
#define LOG(x) BOOST_LOG_STREAM_CHANNEL_SEV(exec_helper_config_logger::get(), LOG_CHANNEL, execHelper::log::x) << boost::log::add_value(fileLog, __FILE__) << boost::log::add_value(lineLog, __LINE__)
