...
namespace execHelper {
    namespace config {
        /**
         * \brief   Class for collecting the values of variables that are expected to change often
         */
        class FleetingOptionsInterface {
            ...
            protected:
                 ...
                 */
                FleetingOptionsInterface& operator=(const FleetingOptionsInterface& other) = default;

                /*! @copydoc config::Argv::operator=(config::Argv&&)
                 */
                FleetingOptionsInterface& operator=(FleetingOptionsInterface&& other) = default;
        };
    } // core
} // ExecHelper
