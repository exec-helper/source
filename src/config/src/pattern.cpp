...
namespace execHelper { namespace config {
    Pattern::Pattern(PatternKey patternKey, PatternValues values, ShortOption shortOption, LongOption longOption) noexcept :
    ...
    bool Pattern::operator==(const Pattern& other) const noexcept {
        return (m_key == other.m_key && m_values == other.m_values && m_shortOption == other.m_shortOption && m_longOption == other.m_longOption);
    }
    ...
    const PatternValues& Pattern::getValues() const noexcept {
        return m_values;
    }
