...
namespace execHelper { namespace plugins {
    ...
    std::string Cppcheck::getPluginName() const noexcept {
        return PLUGIN_NAME;
    }

    VariablesMap Cppcheck::getVariablesMap(const FleetingOptionsInterface& fleetingOptions) const noexcept {
    ...
    bool Cppcheck::apply(Task task, const VariablesMap& variables, const Patterns& patterns) const noexcept {
