...
namespace execHelper { namespace plugins { namespace test {
    ...
    SCENARIO("Obtaining the default variables map of the command-plugin", "[command-plugin]") {
        ...
        MAKE_COMBINATIONS("Of several options and configurations") {
            ...
            THEN_WHEN("We apply the plugin") {
                ...
                THEN_CHECK("All expected actions should be executed") {
                    ...
                    for(auto memoryIterator = memories.begin(); memoryIterator != memories.end(); ++memoryIterator, ++taskIterator) {
