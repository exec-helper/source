...
namespace execHelper { namespace plugins { namespace test {
    SCENARIO("Obtain the plugin name of the clang-static-analyzer plugin", "[clang-static-analyzer]") {
        log::init();
    ...
    SCENARIO("Obtain the default variables map of the clang-static-analyzer plugin", "[clang-static-analyzer]") {
    ...
    SCENARIO("Successfully applying the clang-static-analyzer plugin", "[clang-static-analyzer]") {
