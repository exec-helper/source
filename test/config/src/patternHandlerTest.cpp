    ...
    namespace test {
        SCENARIO("Test the patterns the handler is holding", "[patterns][PatternsHandler]") {
            GIVEN("A patternshandler and some patterns to hold") {
                const Pattern pattern1("pattern1", {"pattern1A", "pattern1B"}, 'a', string("patternA"));
                const Pattern pattern2("pattern2", {"pattern2A", "pattern2B"}, 'b', string("patternB"));
                const Pattern pattern3("pattern3", {"pattern3A", "pattern3B"}, 'c', string("patternC"));
                const Pattern pattern4("pattern4", {"pattern4A", "pattern4B"}, 'd', string("patternD"));
        ...
        SCENARIO("Test invalid conversions to a pattern", "[patterns][PatternHandler]") {
