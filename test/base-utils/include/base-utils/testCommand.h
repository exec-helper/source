...
namespace execHelper {
    namespace test {
        namespace baseUtils {
            ...
            class TestCommand {
                public:
                    TestCommand(const CommandKey& commandKey, const Statements& initialStatements = {}) noexcept;
                    ...
                    unsigned int getNumberOfStatementExecutions() const noexcept;     // Returns the sum of executions of all statements
